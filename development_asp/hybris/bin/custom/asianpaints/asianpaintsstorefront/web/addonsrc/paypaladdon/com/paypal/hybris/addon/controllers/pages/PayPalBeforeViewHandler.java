...
public class PayPalBeforeViewHandler implements BeforeViewHandlerAdaptee
{
	...
	{
		if (PaypaladdonControllerConstants.Views.Pages.MultiStepCheckout.DefaultSilentOrderPostPage.equals(viewName))
		{
			return PaypaladdonControllerConstants.Views.Pages.MultiStepCheckout.SilentOrderPostPage;
		}
		else if (PaypaladdonControllerConstants.Views.Pages.MultiStepCheckout.DefaultCheckoutSummaryPage.equals(viewName))
		{
