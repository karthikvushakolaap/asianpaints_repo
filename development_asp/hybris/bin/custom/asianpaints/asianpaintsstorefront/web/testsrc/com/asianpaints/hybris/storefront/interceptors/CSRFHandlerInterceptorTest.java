 ...
 *
 */
package com.asianpaints.hybris.storefront.interceptors;
...
import com.asianpaints.hybris.storefront.util.CSRFHandlerInterceptor;
import com.asianpaints.hybris.storefront.util.CSRFTokenManager;
...
{
	private static final String SESSION_CSRF_ATTRIBUTE = "com.asianpaints.hybris.storefront.util.CSRFTokenManager.tokenval";
